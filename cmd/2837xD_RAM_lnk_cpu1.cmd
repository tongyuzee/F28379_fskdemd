...
PAGE 1 :
   ...
   RAMGS3      : origin = 0x00F000, length = 0x003000
//   RAMGS4      : origin = 0x010000, length = 0x001000
//   RAMGS5      : origin = 0x011000, length = 0x001000
   RAMGS6      : origin = 0x012000, length = 0x004000		//Enlarge the RAMGS6 to 0x009000
   #if 0
...
SECTIONS
{
   ...
   .stack           : > RAMM1,     PAGE = 1
   .ebss            : > RAMGS6,    PAGE = 1
   .econst          : >> RAMGS0|RAMGS1|RAMGS2|RAMGS3,    PAGE = 1
...
//   Difference_RegsFile : >RAMGS5, 	PAGE = 1, fill=0x3333
   ...
   CFFTdata1        : > RAMGS10,    PAGE = 1, ALIGN(4096)
   CFFTdata3        : > RAMGS12,    PAGE = 1
   CFFTdata4        : > RAMGS14,    PAGE = 1
